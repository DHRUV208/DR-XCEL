...
// colour for change of state in the top bar
...
// left - center - right aligning of txt
...
// this is done so that for all the other column there should be a seperate new properties to be applied on that cell
...
function addListenerToAttachCellProperties(cell) {
    cell.addEventListener("click", (e) => {
        ...
        switch(cellProp.alignment) { // UI-2
            case "left":
                leftAlign.style.backgroundColor = activeColorProp;
                centerAlign.style.backgroundColor = inactiveColorProp;
                rightAlign.style.backgroundColor = inactiveColorProp;
